...
namespace ClienteCara 
{
    ...
    /// <summary>
    /// Método para controlar el evento de inserción de la Tarjeta
    /// </summary>
    public delegate void CardInsertedEventHandler();

    /// <summary>
    /// Método para controlar el evento de extracción de la Tarjeta
    /// </summary>
    public delegate void CardRemovedEventHandler();

    /// <summary>
    /// Clase Abstracta que servirá como base para implementar ICARD 
    /// </summary>
    abstract public class CardBase : ICard
    {
        ...
        /// <summary>
        /// Manejador del evento de inserción de la tarjeta
        /// </summary>
        public event CardInsertedEventHandler OnCardInserted = null;

        /// <summary>
        /// Manejador del evento de extracción de la tarjeta
        /// </summary>
